...
>"Soon enough, you will stop denying the truth of so very many things. And you will understand that I am not a traitor, but a visionary! Fear leads to anger, anger leads to hate, hatred leads to suffering. But what the Jedi failed to teach you, what I have learned, is how to persevere, to pass through suffering, and achieve ultimate power!" - Dooku 

[![DOOKU](Dooku_Headshot.jpg)](https://starwars.fandom.com/wiki/Dooku)
...
_variations of this recipe?_ : None at the moment.

![Photogenic risotto](someday-my-spring-will-come1.jpg)
...
[_Steps!_](https://smittenkitchen.com/2007/01/someday-my-spring-will-come/)
...
In Cartesian coordinates, if $p = (p_1, p_2,..., p_n)$ and $q = (q_1, q_2,..., q_n)$ are two points in Euclidean n-space, then the distance (d) from $\bf{p}$ to $\bf{q}$, or from $\bf{q}$ to $\bf{p}$ is given by the Pythagorean formula:

$$\begin{align} 
d(\bf{p,q}) &= \sqrt{(q_1 - p_1)^2 + (q_2 - p_2)^2 + ... + (q_n - p_n)^2}\\
&= \sqrt{\sum_{i = 1}^{n}(q_i - p_i)^2}.
\end{align}$$

 
The position of a point in a Euclidean n-space is a Euclidean vector. So, p and q may be represented as Euclidean vectors, starting from the origin of the space (initial point) with their tips (terminal points) ending at the two points. The Euclidean norm, or Euclidean length, or magnitude of a vector measures the length of the vector,
$$\left\lVert \bf{p} \right\rVert = \sqrt{p_1^2 + p_2^2 + ... + p_n^2} = \sqrt{\bf{p \cdot p}}$$
